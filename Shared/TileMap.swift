...
class TileMapNode: SKNode {
  ...
  fileprivate var layers = [String : LayerNode]()
  ...
  func tileCoordForPosition(_ position: CGPoint) -> TileCoord {
  ...
  func positionForTileCoord(_ tileCoord: TileCoord) -> CGPoint {
  ...
  func layerNamed(_ name: String, hasObjectNamed objectName: String, atCoord tileCoord: TileCoord) -> Bool {
  ...
  func layerNamed(_ name: String, removeObjectAtCoord tileCoord: TileCoord) {
    if let layer = layers[name] {
...
class LayerNode: SKNode {
  ...
  fileprivate let tileSize: CGSize
  ...
  func hasObjectNamed(_ objectName: String, atCoord tileCoord: TileCoord) -> Bool {
  ...
  func removeObjectAtCoord(_ tileCoord: TileCoord) {
